...
.profile_photo {
	...
	background: #323232;
	width: 1150px;
	background:url(img/pinkback.jpg);
      ...
      <div class="page">
        <header id="header">
          <ul class="nav nav-tabs" role="tablist">
            ...
            <li class="profile"><a href="Userprofile.php">About us</a></li>
						<li class="pokedex"><a href="Userpokedex.php">Pokedex</a></li>
						<li class="board"><a href="Bulletinboard.php">Bulletin board</a></li>
            <li class="contact"><a href="Usercontact.php">Contact us</span></a></li>
								...
								<div class="section-header">
								 <h2>Search Pokemon!!!!</h2><br>	
									<form action="action.php" method="post">
									 <h4 class="pb-4">You can search pokemons based on each information.</h4>
										<div class="container-fluid m-3">		
											Name:<input type="text" name="pname" required>
											<input type="hidden" name="id" value="<?php echo $id;?>">
												<input class="bg-danger text-white" type="submit" name="searchname" value="Search"><br>
										</div>
									</form>
									
								 <form action="action.php" method="post">
									  <div class="container-fluid m-3">
									 Ability:<input type="text" name="abi" required>
									 <input type="hidden" name="abi" value="<?php echo $id;?>">	 
										 <input class="bg-danger text-white" type="submit" name="searchability" value="Search"><br>
									 </div>
								 </form> 	 
								 ...
								 <form action="action.php" method="post">
									 ...
									 <input type="hidden" name="id" value="<?php echo $id;?>"> 
										 <input class="bg-danger text-white" type="submit" name="searchheight" value="Search"><br>
									 </div>
								</form>
								 ...
								 <form action="action.php" method="post">
									 ...
									 Weight:<input type="text" name="weight" required>
										<input type="hidden" name="id" value="<?php echo $id;?>">
											<input class="bg-danger text-white" type="submit" name="searchweight" value="Search">
										</div>
								 </form> 			  
