            ...
            <li class="login"><a href="logout.php">Log out</span></a></li>
              ...
              <div class="profile_photo">
					 ...
					 <div class="container-fluid w-100">
						 <div class="mx-auto">
						  <p class="mb-5">Let's talk with other members to be Pokemon master...</p>
              
										<?php
											include 'classes/pokesql.php';
											$poke=new SQL();
											$result=$poke->postComment();
                   ...
                   Comment:<textarea name="comment"  cols="45" rows="2"></textarea><br><br>
                   
											<input class="bg-danger" type="submit" name="post" value="Write comment.">	
               </form>		
						 </div>
