            ...
            <li class="profile"><a href="profile.php">About us</a></li>
              ...
              <div class="profile_photo">
								...
								<div class="section-header">
								   <h2>Check skills!!!!</h2><br>

								 <form action="searchpokedata.php" method="post">
									 <h4 class="pb-4">You can know the details of skill.</h4>
										<div class="container-fluid m-3">		
											Name:<input type="text" name="skill" required>
											<input type="hidden" name="id" value="<?php echo $id;?>">
												<input class="bg-primary text-white" type="submit" name="searchskill" value="Search"><br>
										</div>
								 </form>

								 <form action="searchpokedata.php" method="post">
										<div class="container-fluid m-5">		
											Type:<select class="w-25 ml-2 mr-2" name="stype" required>
											...
											<input type="hidden" name="id" value="<?php echo $id;?>">
												<input class="mr-5 bg-primary text-white" type="submit" name="searchstype" value="Search"><br>
										</div>
								 </form>
						<?php
						     if($_SESSION["id"]!=NULL){
									...
									<h2>Battle simulator(Only members can try!!!)</h2><br>
										 
									<div class='container-fluid m-3'>	
										 <input class='bg-primary text-white' type='submit' name='start' value='Start the battle.'>
								 </div>
