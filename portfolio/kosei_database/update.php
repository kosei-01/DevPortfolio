  ...
  <div class="ml-5 text-white">
		<h1 class='pt-2'>Update page</h1>	
			<form action="action.php" method="post">
					<div class='p-5'>
						Name<br>
						<input class='w-50 form-control' type='text' name='uname'><br>
						Password<br>
						<input class='w-50 form-control' type='password' name='pass'><br>
						E-mail<br>
						<input class='w-50 form-control' type='email' name='email' ><br>
