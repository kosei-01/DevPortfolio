...
<div class="container-fluid w-100">
  <div class="ml-5 text-white">
		<h1 class='pt-2'>Update page</h1>	
			<form action="action.php" method="post">
					<div class='p-5'>
						Name<br>
						<input class='w-50 form-control' type='text' name='uname' value='<?php echo $result['user_name'] ;?>'><br>
						Password<br>
						<input class='w-50 form-control' type='password' name='pass' value='<?php echo $result['password'] ;?>'><br>
						E-mail<br>
						<input class='w-50 form-control' type='email' name='email' value='<?php echo $result['email'] ;?>'><br>
						<input type='hidden' name='id' value='<?php echo $id;?>'>
						<input class='bg-danger mt-4 w-50 form-control' type='submit' name='update' value='Update data'>
				 </div>
			</form>
	</div>
</div>	
