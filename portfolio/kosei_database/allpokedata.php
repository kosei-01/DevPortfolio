      ...
      <div class="page">
		...
		<?php  
			...
			foreach($result as $rows){
				...
				echo"<p class='text-white '>".$pname."</p><br>";
				
					echo"<div class='mt-5'>";
							echo"<p class='text-white'>Type1:".$type1."</p>";
						if($type2!=NULL){
									echo"<p class='text-white'>Type2:".$type2."</p><br>";
						}	
						else{
              		echo"<p class='text-white'>Type2:none</p><br>";
						}
							
							echo"<p class='text-white'>Ability:".$abi."</p><br>";
						if($abi2!=NULL){
									echo"<p class='text-white'>Ability2:".$abi2."</p><br>";
						}
						else{
								  echo"<p class='text-white'>Ability2:none</p><br>";
						}
						if($habi!=NULL){
									echo"<p class='text-white'>Hidden-ability:".$habi."</p><br>";
						} 	
						else{
								echo"<p class='text-white'>Hidden_ability:none</p><br>";
					  }	
							echo"<p class='text-white'>Height:".$height."</p><br>";
							echo"<p class='text-white'>Weight:".$weight."</p><br>";
							echo"<p class='text-white'>Text:".$text."</p><br>";
         echo"</div><br><br><br>";

			}		
  	?>
		    
		    <p class="text-white p-5 float-left">I'm sorry... This page is under renewal.</p>
		               </div>
                 </div>
               </div>
		         </div>
