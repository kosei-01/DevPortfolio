 ...
 <form method="post" action="action.php" enctype="multipart/form-data" class="mt-5">
	 <div class="text-white w-100">
          Name<br>
					...
					Type-1<br>
					<select name="type1" class="form-control w-75">
					...
					Type-2<br>
					<select name="type2"  class="form-control w-75">
				    	<option value="normal">Normal</option>
							<option value="fighting">Fighting</option>
							<option value="flying">Flying</option>
							<option value="poison">Poison</option>
					...
					<input type="hidden" name="poke_id" value=<?php echo $id;?>>
					<input type='submit' value="Update" name="updatepokemon" class="btn btn-primary btn-block w-75 mb-4">
