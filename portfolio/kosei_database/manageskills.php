 ...
 <form method="post" action="action.php" enctype="multipart/form-data" class="mt-5">
	 <div class="text-white">
	   ...
	   <h1>Please add new data.</h1>
		 <p>If you'd like to check skill's data.<a href="checkskills.php">Click here.</a></p>
				 Skill<br>
				<input type='text' name="skill" class="form-control w-75"><br>

				Skill-type<br>
				<select class="form-control w-75" name="stype">
        ...
        Accurancy<br>
				...
				Skill-text:<textarea name="stext" class="form-control w-75"></textarea><br>
				

				<input type='submit' value='Upload' name='uploadskill' class="btn btn-primary btn-block w-75 mb-4">
   </div>
  </form>
 </div>	
