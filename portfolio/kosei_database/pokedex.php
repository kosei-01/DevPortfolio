            ...
            <li class="profile"><a href="profile.php">About us</a></li>
              ...
              <div class="profile_photo">
								...
								<div class="section-header">
								 ...
								 <form action="searchpokedata.php" method="post">
								 ...
								 <form action="searchpokedata.php" method="post">
										<div class="container-fluid m-5">		
											Type:<select class="w-25 ml-2 mr-2" name="type" required>
											...
											<input type="hidden" name="id" value="<?php echo $id;?>">
												<input class="mr-5 bg-danger text-white" type="submit" name="searchtype" value="Search"><br>
										</div>
								 </form>
